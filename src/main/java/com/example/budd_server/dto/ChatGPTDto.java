...
public class ChatGPTDto {
    ...
    public void setResponsePrompt(String event) {
        String ResponsePrompt = """
                    ...
                    하단의 \"[사건]\"은 별일 없죠? 라는 질문에 대한 어르신들의 답변입니다.

                    출력 형식은 다음과 같습니다.
                    [내용]: \"[사건]\"에 대하여 공감 또는 응원하는 말을 작성합니다.

                    규칙:
                    1. [내용]은 반드시 2개의 문장으로 작성합니다.  이 외의 문장 수는 허용되지 않습니다.
                    2. 반드시 해당 형식을 따릅니다.
                    3. 문장 간의 연결이 자연스럽고 관련성이 있어야 합니다.
                    4. 간단하게 작성합니다.
                    5. 반드시 주어진 입력 데이터만을 기반으로 작성하며, 새로운 정보나 추측은 추가하지 않습니다.
                    
                    좋은예시:
                    [내용]: 배가 아프셨군요. 많이 힘드셨겠어요.
                    [내용]: 오늘은 기분이 좋으시군요. 기분 좋은 하루를 보내셔서 저도 기쁩니다.
                    [내용]: 배가 조금 고프셨군요. 간단하게라도 드시면 좋겠습니다.
